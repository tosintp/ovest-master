      ...
      <div className="silvestinvestment-body">
        <div className="silvestinvestment-main">
          ...
          <p className="silvestinvestment-textbody">
            Silvest Investment Plan is a 3 months plan with a minimum capital of
            N 50,000. The interest rate is 50% which would be paid 15% monthly
            and the third month would be 20% and the initial capital.
          </p>
        </div>
