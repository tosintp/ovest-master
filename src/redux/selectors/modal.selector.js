...
export const showWithdrawalModalState = createSelector([selectModal], (modal) => modal.showWithdrawalModalState);


export const hideModalState = createSelector([selectModal], (modal) => modal.hideModal);
export const hideWithdrawalModalState = createSelector([selectModal], (modal) => modal.hideWithdrawalModalState);
